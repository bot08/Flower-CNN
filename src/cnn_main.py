# python e:/AI_a/CNN-10/src/cnn_main.py
...
DATA_PATH_TRAIN = Path('E:\\AI_a\\flowers')
DATA_PATH_TEST = Path('E:\\AI_a\\flowers')
MODEL_STORE_PATH = Path('E:\\AI_a\\flowers')
...
def train(num_epoch):
    ...
    for epoch in range(num_epoch):
        ...
        train_loss = train_loss / len(train_dataset)*2
